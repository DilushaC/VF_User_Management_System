...
namespace UserManagement.Business.DesignationHandler
{
    public class DesignationService : IDesignationService
    {
        ...
        public async Task<bool> DeleteDesignationAsync(IFormCollection collection)
        {
            try
            {
                ...
                string checkSql = "SELECT COUNT(1) FROM Users WHERE DesignationId = @Id";
                ...
                string deleteSql = "DELETE FROM Designation WHERE Id = @Id";
